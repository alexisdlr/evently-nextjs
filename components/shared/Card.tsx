...
const Card = ({ hasOrderLink, hidePrice, event }: CardProps) => {
  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden  rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px] dark:bg-slate-500/10">
      <Link
      ...
      {isOrganizer && !hidePrice && (
        <div className="absolute top-5 right-5 hover:bg-slate-500/20 bg-white transition-all rounded-xl shadow-lg p-2">
